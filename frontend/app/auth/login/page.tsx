      ...
      <div className="relative z-10 flex w-full max-w-6xl items-center gap-12 px-4">
        ...
        >
          ...
          <div className="space-y-6">
            <div>
              <h2 className="mb-3 text-4xl font-bold text-white">Welcome Back!</h2>
              <p className="text-xl text-slate-300">Continue your journey to ace your interviews</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Smart Resume Analysis</h3>
                  <p className="text-sm text-slate-400">Get AI-powered feedback on your resume</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Practice Interviews</h3>
                  <p className="text-sm text-slate-400">Improve with voice-enabled interview practice</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Monitor improvements with detailed analytics</p>
                </div>
              </div>
            </div>
          </div>
